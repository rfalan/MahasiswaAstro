...
export default function Dashboard() {
  ...
  return <main className="app-shell">
    ...
    <section className="content"><header className="topbar"><div className="breadcrumb"><span>Workspace</span><b>/</b><strong>{activeNav === 'students' ? 'Mahasiswa' : activeNav === 'analytics' ? 'Analitik' : 'Overview'}</strong></div><div className="top-actions"><button className="icon-button" aria-label="Notifikasi"></button><span className="date"></span></div></header>
